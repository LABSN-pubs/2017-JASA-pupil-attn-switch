...
\makeatletter
%% put trailing periods in section title numbers
\renewcommand{\@seccntformat}[1]{\csname the#1\endcsname.\quad}
%% put medial (but not trailing) periods in cross-references
